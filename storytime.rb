...
puts 'Two lines are available for you to enter. To your LEFT, a line of only three elderly citizens fumble their paperwork and struggle to hear their own conversations. To your RIGHT, a line of approximately ten typical modern urban youth. This choice is yours alone, which line doth thou join? LEFT... or RIGHT?'
...
if line_choice == 'LEFT' 
    ...
    puts 'Please make a valid choice, for once'
end
...
if left_choice2 == 'BATHROOM'
    ...
    puts 'This old man is lit. Time flies, hope renews. Everything is fine. Your number is called, and updating your registration is easy.'
else
    puts 'Please make a valid choice, for once'
end
...
if right_choice2 == 'YES'
    ...
    puts 'The trainee is unable to assist you with your issue. But, it turns out you can do this all online. You have wasted your life.'
else 
    puts 'Please make a valid choice, for once'
end
